...
//#endregion
//#region ui/components/StatusCard.tsx
...
function StatusCard({ status }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `inline-block w-2.5 h-2.5 rounded-full ${cfg.dot}` }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: `text-sm font-medium ${cfg.text}`,
				children: cfg.label
			}),
			status.message && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
//#endregion
//#region ui/components/PrinterConfigForm.tsx
var DEFAULT = {
	MANDO_AGENT_TOKEN: "",
...
function PrinterConfigForm({ initial, onSave }) {
	const [form, setForm] = (0, import_react.useState)(DEFAULT);
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: "Ingresa tu codigo de vinculacion, elige tu impresora y guarda."
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "rounded-xl border border-gray-800 bg-gray-900/70 p-3 text-xs text-gray-300 space-y-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "font-semibold text-gray-100",
					children: "Inicio rapido"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
					className: "list-decimal list-inside space-y-1 text-gray-400",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Copia tu codigo desde Mando." }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Selecciona como esta conectada tu impresora." }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Guarda los cambios y la app se conectara sola." })
					]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: "Codigo de vinculacion *"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-xs text-gray-400",
					children: "Como esta conectada tu impresora"
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
						value: "network",
						children: "Por WiFi o red"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
						value: "serial",
						children: "Por cable USB"
					})]
				})]
			}),
			printerType === "network" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			printerType === "serial" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
					className: "flex flex-col gap-1 flex-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-xs text-gray-400",
					children: "Tamano del papel"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex gap-2",
					children: ["58mm", "80mm"].map((w) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => set("PAPER_WIDTH", w),
						className: `flex-1 py-1.5 rounded text-sm font-medium border transition-colors ${form["PAPER_WIDTH"] === w ? "bg-indigo-600 border-indigo-500 text-white" : "bg-gray-800 border-gray-700 text-gray-400 hover:border-gray-500"}`,
						children: w
					}, w))
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-col gap-2 pt-2 border-t border-gray-800",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: saving ? "Guardando..." : "Guardar y conectar"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
					className: "rounded-lg border border-gray-800 bg-gray-900/40 px-3 py-2 text-xs text-gray-400",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-xs text-gray-400",
								children: "Direccion del servidor"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "url",
							...
							children: "Abrir archivo de configuracion"
						})]
					})]
				})]
			})
...
//#endregion
//#region ui/components/JobLog.tsx
...
function JobLog({ jobs }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex flex-col h-full",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "px-5 py-3 border-b border-gray-800 shrink-0 flex items-center justify-between",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "text-sm font-semibold uppercase tracking-widest text-gray-500",
				children: "Log de trabajos"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				className: "text-xs text-gray-600",
				children: [jobs.length, " trabajos"]
			})]
			...
			children: "Esperando trabajos de impresión..."
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "flex-1 overflow-y-auto divide-y divide-gray-800/60",
			children: jobs.map((job) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-start gap-3 px-5 py-2.5 hover:bg-gray-900/50 transition-colors",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "pt-0.5 shrink-0",
						children: job.success === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "inline-block w-2 h-2 rounded-full bg-yellow-400 animate-pulse mt-1" }) : job.success ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "inline-block w-2 h-2 rounded-full bg-green-400 mt-1" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "inline-block w-2 h-2 rounded-full bg-red-500 mt-1" })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: formatTime(job.timestamp)
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "text-sm text-gray-200 font-medium truncate",
									children: ["#", job.orderId]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: `text-xs px-1.5 py-0.5 rounded font-medium ${job.ticketType === "RECEIPT" ? "bg-blue-900/60 text-blue-300" : "bg-orange-900/60 text-orange-300"}`,
									children: job.ticketType === "RECEIPT" ? "Recibo" : "Cocina"
								}),
								job.success === true && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-xs text-green-400",
									children: "✓ OK"
								}),
								job.success === false && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-xs text-gray-700 font-mono shrink-0 hidden xl:block truncate max-w-32",
						title: job.jobId,
						children: job.jobId
					})
				]
...
//#region ui/App.tsx
function App() {
	const [status, setStatus] = (0, import_react.useState)({ status: "connecting" });
	...
	(0, import_react.useEffect)(() => {
		...
		const off3 = window.api.onAgentResult((result) => {
			setJobs((prev) => prev.map((j) => j.jobId === result.jobId ? {
				...j,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex flex-col h-screen bg-gray-950 text-gray-100 font-sans select-none",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			className: "flex items-center justify-between px-5 py-3 border-b border-gray-800 bg-gray-900 shrink-0",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusCard, { status })]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex flex-1 overflow-hidden",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
				className: "w-80 shrink-0 border-r border-gray-800 overflow-y-auto",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PrinterConfigForm, {
					initial: config,
					onSave: handleSave
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
				className: "flex-1 overflow-hidden",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(JobLog, { jobs })
			})]
		})]
	});
}
